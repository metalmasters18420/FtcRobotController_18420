...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 3020.387760484107; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -243.3483461343449; // x position of the perpendicular encoder (in tick units)
    }
